# !/bin/bash
# Native build on RISC-V platform (no cross-compilation toolchain needed)
# bash build_whl_rv_native.sh ${LLVM_INSTALL_DIR} riscv64 {spine-mlir-install-dir}
...
# No CC/CXX override needed: running natively on RISC-V, system gcc targets the host platform
